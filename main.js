...
function about_quickLib() {
    ...
    displayAbout += "<p>&#1023; Author: Kopitar Anže</p><p>&#1023; Homepage: <a href=\"https://github.com/kopytar/brackets-quicklib\" >https://github.com/kopytar/brackets-quicklib</a></p>";
...
CommandManager.register("About Extension", MNU_ABOUT, about_quickLib );
               
// construct the menu for this extension, show it & register all commands    
constructMenu();
menu.addMenuDivider();
